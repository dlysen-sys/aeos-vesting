...
library TickMath {
    ...
    uint160 internal constant MAX_SQRT_RATIO = 1461446703685121572292542592825750529;
    ...
    function getTickAtSqrtRatio(uint160 sqrtPriceX96) internal pure returns (int24 tick) {
        ...
        int256 log_sqrt10001 = log_2 * 255738958999603826347141; // 128.128 fixed point

        int24 tickLow = int24((log_sqrt10001 - 3402992956753258740407) >> 128);
        int24 tickHi = int24((log_sqrt10001 + 291339464771989622907) >> 128);
